...
import com.drivemode.media.sample.databinding.FragmentAudioPlaylistsBinding;
 ...
 */
public class AudioPlaylistsFragment extends Fragment {
	private FragmentAudioPlaylistsBinding binding;
	...
	public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
		return inflater.inflate(R.layout.fragment_audio_playlists, container, false);
	}

	@Override
	public void onActivityCreated(@Nullable Bundle savedInstanceState) {
		super.onActivityCreated(savedInstanceState);
		binding = FragmentAudioPlaylistsBinding.bind(getView());
		...
		Observable.fromCallable(() -> facade.playlist().fetchLists())
