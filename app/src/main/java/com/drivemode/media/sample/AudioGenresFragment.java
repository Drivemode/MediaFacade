...
import com.drivemode.media.sample.databinding.FragmentAudioGenresBinding;
 ...
 */
public class AudioGenresFragment extends Fragment {
	private FragmentAudioGenresBinding binding;
	...
	public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
		return inflater.inflate(R.layout.fragment_audio_genres, container, false);
	}

	@Override
	public void onActivityCreated(@Nullable Bundle savedInstanceState) {
		super.onActivityCreated(savedInstanceState);
		binding = FragmentAudioGenresBinding.bind(getView());
		...
		Observable.fromCallable(() -> facade.genre().fetchGenres())
